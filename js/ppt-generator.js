...
const STYLES = PPT_STYLES_RAW.map(s => ({
  ...s,
  bg: typeof window !== 'undefined' ? window.GLOBAL_STYLES_CONFIG[s.id].bg.replace('#', '') : s.bg,
  colors: typeof window !== 'undefined' ? window.GLOBAL_STYLES_CONFIG[s.id].colors.map(c => c.replace('#', '')) : s.colors,
  vibe: typeof window !== 'undefined' ? window.GLOBAL_STYLES_CONFIG[s.id].vibe : s.vibe
}));
